...
class SubwayStation(MetroStation):
    ...
    def show_info(self):
        open_info = 'open' if self.is_open else 'closed'
        print(f'{self.station_name} station is located at {self.location}. It is currently {open_info}. The following subway lines stop there: {self.lines}.')
...
# lines: ['1', '2', '3', 'L']
fourteenth_street = SubwayStation('14th street', '14th street and 7th avenue', ['1', '2', '3', 'L'])
...
class BusStation(MetroStation):
    ...
    def show_info(self):
        open_info = 'open' if self.is_open else 'closed'
        print(f'{self.station_name} station is located at {self.location}. It is currently {open_info}. The following bus routes stop there: {self.routes}')
